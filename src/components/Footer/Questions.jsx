...
const Questions = () => (
    <div>
        <Question>Aut fore senserit arbitror ex nisi probant et coniunctione. Appellat est dolor possumus, do iis quis senserit.</Question>
        <AnswerList>
            <Answer>- Doctrina veniam labore iis fugiat et cupidatat sed tempor incididunt.</Answer>
            <Answer>- Quae eruditionem nescius dolor nescius te in et illum admodum.</Answer>
        </AnswerList>
